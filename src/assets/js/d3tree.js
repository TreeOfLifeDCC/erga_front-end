            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (var i = 0; i < total; i++) {
                        ...
                        var organismElement = '<a class="no-underline" target="_blank" href="https://portal.erga-biodiversity.eu/data_portal/' + organismId + '">' + organism + '</a>'
